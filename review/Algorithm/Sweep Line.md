...
![image-20220913232430229](/Users/youhao/Library/Application Support/typora-user-images/image-20220913232430229.png)
...
找出最多不重叠的区间， 但是这里如果之前的end和 cur 的start一样要判定为重叠，所以为point[0] > end而不是 >=。 找出最多不重叠，就能求出需要多少箭

![image-20220913232409448](/Users/youhao/Library/Application Support/typora-user-images/image-20220913232409448.png)